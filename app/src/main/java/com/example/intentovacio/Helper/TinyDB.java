...
public class TinyDB {
    ...
    public ArrayList<ListDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ListDomain> playerList =  new ArrayList<ListDomain>();

        for(String jObjString : objStrings){
            ListDomain player  = gson.fromJson(jObjString,  ListDomain.class);
    ...
    public void putListObject(String key, ArrayList<ListDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ListDomain player: playerList){
